		...
		<div class="container">
			...
			<?php
				...
				if(isset($_POST['search']))
				{
					...
					$qry = mysqli_query($link,"SELECT * FROM `add_camera` WHERE brand_name LIKE '%$searchq%' OR color LIKE '%$searchq%' ");
				...
				{ ?>
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<a href="product_detail_c.php?c_id=<?php echo $sbrand_name;?>">
