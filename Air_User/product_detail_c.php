						...
						<div><br></div>
									...
									<ul class="p-lr-28 p-lr-15-sm">
										...
										<li class="flex-w flex-t p-b-7">
											...
											<span class="stext-102 cl6 size-206">
												<?php echo $row['effective_pixels'];?>&nbsp;MP
											</span>
										</li>
										<li class="flex-w flex-t p-b-7">
											<span class="stext-102 cl3 size-205">
										...
										<li class="flex-w flex-t p-b-7">
											...
											<span class="stext-102 cl6 size-206">
												<?php echo $row['video_resolution'];?>&nbsp;P
											</span>
										</li>
										</ul>
						...
						<div class="p-t-33">
							...
							<div class="flex-w flex-r-m p-b-10">
								<div class="size-204 flex-w flex-m respon6-next">
									...
									<button name="sub_c" type="submit" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail">
										Add to cart
									</button>
									</a>
